...
//   Config::SetDefault("ns3::DropTailQueue::MaxPackets", StringValue("20"));
  ...
  topologyReader.SetFileName("/home/btp/ndnSIM/my-simulations/extensions/single-service-demonstration.txt");
  topologyReader.Read();
  ...
  std::vector<string> producer_names{"serviceA1", "serviceA2", "serviceA3", "serviceB1", "serviceB2", "serviceC1", "serviceC2", "serviceC3", "serviceC4", };
